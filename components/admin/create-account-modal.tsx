  ...
  const handleCreateAccount = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Account created for ${request.full_name}. Make sure to share the password securely.`,
      });
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Generate a secure password and create an account for this investor.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <Alert>
            ...
            <AlertDescription>
              After creating the account, securely share the password with the investor.
